...
class TestClientBattle(unittest.TestCase):
    def setUp(self):
        ...
        self.valid_server_adress = 'http://localhost'
        self.valid_server_port = '5000'
        self.valid_clientbattle = ClientBattle(self.valid_poke, self.valid_server_adress, self.valid_server_port)

    def test_init(self):
        #regular use of constructor
        self.assertTrue(isinstance(ClientBattle(self.valid_poke, self.valid_server_adress, self.valid_server_port), ClientBattle))
        ...
        self.assertRaises(TypeError, ClientBattle, object(), self.valid_server_adress, self.valid_server_port)
        ...
        self.assertRaises(TypeError, ClientBattle, self.valid_poke, self.valid_server_adress, object())
